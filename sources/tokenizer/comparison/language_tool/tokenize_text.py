...
groovy_path = "/Users/horielov.d/.sdkman/candidates/groovy/current/bin/"
my_env["PATH"] = my_env["PATH"] + os.pathsep + groovy_path


groovy_cmd = 'groovy.bat' if sys.platform == "win32" else 'groovy'
cmd = [groovy_cmd, SCRIPT_PATH + '/TokenizeText.groovy', '-i', '-', "-w"]
